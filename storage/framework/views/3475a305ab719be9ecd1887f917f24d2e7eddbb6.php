<fieldset>
  ...
  --><div id="bobotdiv<?php echo e($i); ?>" class="inblock panel-huruf" style="box-shadow:0px 0px 6px #363636">
      ...
      <img id="bobotimg<?php echo e($i); ?>" src="<?php echo asset("huruf/$bobot->imgname.png"); ?>">
 ...
 --><script type="text/javascript">
      ...
      $("#bobotinp<?php echo e($i++); ?>").on("change",function(){
        if (this.value!="") {
          ...
          generate_token();
          ajax_operation("post",window.location.href+"/simpan-perubahan/<?php echo e($bobot->no); ?>/<?php echo e($bobot->imgname); ?>/"+this.value+"/"+hal,"panel-data-latih");
        }
      });
    </script><!--
  ...
  -->
  <script type="text/javascript">
    $("#panel-data-bobot").slideDown(400);
    $(".pagination a, .pagination span").click(function(event) {
      ...
      ajax_operation("get",url,"panel-data-bobot");
      $("#panel-data-bobot").slideToggle(400);
    });
  </script>
</fieldset>
