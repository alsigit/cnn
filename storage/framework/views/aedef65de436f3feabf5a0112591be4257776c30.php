<html>
  ...
  <link rel="stylesheet" href="<?php echo asset("/css/jquery-confirm.css"); ?>">
  <link rel="stylesheet" href="<?php echo asset("/css/jquery-ui.css"); ?>">
  <script type="text/javascript" src="<?php echo asset("/js/index.js"); ?>"></script>
  <script type="text/javascript" src="<?php echo asset("/js/jquery.js"); ?>"></script>
  <script type="text/javascript" src="<?php echo asset("/js/jquery-ui.js"); ?>"></script>
  <script type="text/javascript" src="<?php echo asset("/js/jquery-confirm.js"); ?>"></script>
  <body>
    <div id="load"></div>
    <header>
    ...
    <div id="container">
      ...
      <div id="olah-data">
        <div class="wrapper">
          <?php echo $__env->make("container.olah-data", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
      </div>
      <div id="training" class="hide">
        <div class="wrapper">
          <?php echo $__env->make("container.training", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
      </div>
      <div id="testing" class="hide">
        <div class="wrapper">
          <?php echo $__env->make("container.testing", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
      </div>
    </div>
  </body>
  <script type="text/javascript">
    ...
    var url = "<?php echo asset("/image/camera.png"); ?>";
